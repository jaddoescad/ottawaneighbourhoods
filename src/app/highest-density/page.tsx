...
export default function HighestDensity() {
  const [showCoverageMap, setShowCoverageMap] = useState(false);

  const sorted = [...neighbourhoods].sort((a, b) => b.populationDensity - a.populationDensity);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-4 text-center">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">
          Highest Density Neighbourhoods in Ottawa
        </h1>
        <p className="text-gray-600 mt-2 text-sm sm:text-base">
          Ranked by population density (people per km²)
        </p>
      </div>

      <FilterBar activeFilter="high-density" />
