...
export default function SafestNeighbourhoods() {
  ...
  const sorted = [...neighbourhoods].sort((a, b) =>
    (b.categoryScores?.safety || 0) - (a.categoryScores?.safety || 0)
  );
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-4 text-center">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">
          Safest Neighbourhoods in Ottawa
        </h1>
