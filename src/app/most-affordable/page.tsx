...
export default function MostAffordable() {
  ...
  // Sort by affordability (lowest rent first)
  const sorted = [...neighbourhoods].sort((a, b) => a.avgRent - b.avgRent);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-4 text-center">
        ...
        <p className="text-gray-600 mt-2 text-sm sm:text-base">
          Ranked by average rent prices (lowest first)
        </p>
      </div>

      <FilterBar activeFilter="affordable" />
