...
export default function MostImmigrants() {
  const [showCoverageMap, setShowCoverageMap] = useState(false);

  // Sort by percentage of immigrants (highest first)
  const sorted = [...neighbourhoods].sort((a, b) => (b.pctImmigrants || 0) - (a.pctImmigrants || 0));
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 text-center">
        ...
        <p className="text-gray-600 mt-2 text-sm sm:text-base">
          Ranked by percentage of population that are immigrants (2021 Census)
        </p>
      </div>

      <FilterBar activeFilter="immigrants" />
