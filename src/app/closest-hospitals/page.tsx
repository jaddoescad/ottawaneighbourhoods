...
export default function ClosestHospitals() {
  ...
  const sorted = [...neighbourhoods].sort((a, b) => {
    const distA = a.details.distanceToNearestHospital ?? 999;
    const distB = b.details.distanceToNearestHospital ?? 999;
    return distA - distB;
  });
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-4 text-center">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">
          Ottawa Neighbourhoods Closest to Hospitals
        </h1>
        <p className="text-gray-600 mt-2 text-sm sm:text-base">
          Ranked by distance to nearest hospital (shortest first)
        </p>
      </div>

      <FilterBar activeFilter="hospitals" />
