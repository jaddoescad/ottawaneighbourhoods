...
export default function RichestNeighbourhoods() {
  ...
  // Sort by median income (highest first)
  const sorted = [...neighbourhoods].sort((a, b) => (b.medianIncome || 0) - (a.medianIncome || 0));
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-4 text-center">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">
          Richest Neighbourhoods in Ottawa
        </h1>
        <p className="text-gray-600 mt-2 text-sm sm:text-base">
          Ranked by median household income (2021 Census)
        </p>
      </div>

      <FilterBar activeFilter="richest" />
