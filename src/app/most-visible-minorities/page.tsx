...
export default function MostVisibleMinorities() {
  const [showCoverageMap, setShowCoverageMap] = useState(false);

  // Sort by percentage of visible minorities/racialized population (highest first)
  const sorted = [...neighbourhoods].sort((a, b) => (b.pctRacialized || 0) - (a.pctRacialized || 0));
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-4 text-center">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">
          Neighbourhoods with Most Visible Minorities in Ottawa
        </h1>
        <p className="text-gray-600 mt-2 text-sm sm:text-base">
          Ranked by percentage of racialized population (2021 Census)
        </p>
      </div>

      <FilterBar activeFilter="visible-minorities" />
